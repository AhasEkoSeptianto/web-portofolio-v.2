        ...
        <div className="w-10/12 lg:w-1/3 h-full bg-gray-200 border rounded-lg shadow-lg overflow-auto  z-20">
          ...
          <div className="flex bg-gray-100 text-white p-5 relative">
            <a href="#site" id="site_porto">
              <button className="border border-blue-500 text-blue-500 rounded px-2 lg:px-5 py-1 mx-1 hover:bg-blue-500 hover:text-white">
                Demo
              </button>
            </a>
            ...
            <button
              className="absolute right-0 border border-red-500 text-red-500 rounded mr-5 px-2 lg:px-5 py-1 mx-1 hover:bg-red-500 hover:text-white"
              onClick={this.close}
            >
              Exit
            </button>
