...
class about extends Component {
  ...
  render() {
        ...
        <div>
          ...
          <nav className='sticky top-0 shadow z-40'>
            <ul className='flex items-center divide-x bg-gray-700 text-gray-200 lg:text-lg'>
              <a href='#home'>
                <li className=' py-3 px-3 lg:px-9 cursor-pointer hover:bg-blue-500' id='navHome'>Home</li>
              </a>
              <a href='#about'>
                  <li className='py-3 px-3 lg:px-9 cursor-pointer hover:bg-blue-500' id='navAbout'>
                      About
                  </li>
              </a>
              <a href='#portofolio'>
                  <li className='py-3 px-3 lg:px-9 cursor-pointer hover:bg-blue-500' id='navPortofolio'>
                      Portofolio        
                  </li>
              </a>
              <a href='#contact'>
                <li className='py-3 px-3 lg:px-9 cursor-pointer hover:bg-blue-500' id='navContact'>Contact</li>
              </a>
            </ul>
          </nav>
          ...
          {/* about */}
          <div className='mt-20 lg:mt-32 text-gray-800' >
              
              <div id='about'></div>
            <h1 className='text-center py-20 text-2xl lg:text-5xl font-bold transition duration-700 opacity-0 title' id='anim_about'>About</h1>
            <div className='container mx-auto grid lg:grid-cols-2 text-center text-gray-600 divide-x items-center'>  
              ...
              <div id='info_gue' className='transition duration-700'>
                <div className='relative flex justify-center items-center'>
                  <img src={ImageGue} className='mx-auto rounded-2xl w-1/3 shadow' id='img' alt='myself' />
                </div>
    ...
    I really like programming and motivated</p>
              ...
              {/* about right */}
              <div>
                <h2 className='font-bold text-2xl my-20 opacity-0 lg:my-0' id='skill_title'>Skills</h2>

                <div className='flex flex-wrap mt-10'>
                  {allIconsSkill.map((val, index) => (
                    <div className='py-4 flex flex-col justify-center items-center opacity-0 transition duration-700 hover:shadow w-1/2 lg:w-1/5 ' key={index} id={`icons_skill_${index}`} >
          ...
          <div className='my-40 lg:my-52'>

              <div  id='portofolio'></div>
              <h1 className='text-center py-20 text-2xl lg:text-5xl font-bold opacity-0 transition duration-700 title' id='anim_portofolio'>Portofolio</h1>
          ...
          {/* contect */}
          <div>
            <img src={'/image/draw.png'} className='w-full' alt='svg' />
          </div>
          <div className='contact_content'>
            <div className='-mt-1 contact py-20'>
              <div id='contact'></div>
               <h1 className='text-center pt-10 lg:pt-20 lg:pb-10 text-2xl lg:text-5xl font-bold opacity-0 transition duration-700 title_contact' id='anim_contact'>Contact</h1>
            </div>

            <div className='text-white pt-10 lg:pt-0 pb-32 opacity-0 transition duration-700' id='anim_msg_content'> 
