...
class about extends Component {
  ...
  async componentDidMount() {
    ...
    document.addEventListener("scroll", (e) => {
      ...
      if (scroll > 800) {
        // profille info show
        document.getElementById("info_gue").style.cssText =
      ...
      <div>
        ...
        <div>
          ...
          <div className="h-screen relative">
            ...
            <div className="absolute top-0 bg-gray-900 h-full w-full opacity-60"></div>{" "}
            {/* opacity */}
            <div className="absolute top-0 h-screen w-screen flex justify-center items-center text-white">
              <h1 className="font-bold text-center text-lg lg:text-2xl">
                HI, I'm Eko. I Build Website & Mobile App
              </h1>
            </div>
          </div>
          ...
          <nav className="sticky top-0 shadow z-40">
            <ul className="flex items-center divide-x bg-gray-700 text-gray-200 lg:text-lg">
              <a href="#home">
                <li
                  className=" py-3 px-3 lg:px-9 cursor-pointer font-bold hover:bg-blue-500"
                  id="navHome"
                >
                  Home
                </li>
          ...
          <div className="mt-18 lg:mt-32 text-gray-800">
            <div id="about"></div>
            <h1
              className="text-center py-20 text-4xl lg:text-5xl font-bold transition duration-700 opacity-0 title"
              id="anim_about"
            >
              About
            </h1>
            <div className="container mx-auto grid lg:grid-cols-2 text-center text-gray-600 divide-x items-center">
              ...
              <div id="info_gue" className="transition duration-700">
                <div className="relative flex justify-center items-center">
                  <img
                    src={ImageGue}
                    className="mx-auto rounded-2xl w-8/12 lg:w-1/3 shadow"
                    id="img"
                    alt="myself"
                  />
                </div>
                <div className="mt-10 text-sm">
                  ...
                  <p className="w-2/3 my-2 mx-auto font-semibold  lg:text-lg">
                    I am Ahas Eko Septianto, I am a front end developer, my
                    skills are on the website and mobile developer I really like
                    programming and motivated
                  </p>
              ...
              <div>
                <h2
                  className="font-bold text-4xl lg:text-5xl my-20 opacity-0 lg:my-0"
                  id="skill_title"
                >
                  Skills
                </h2>
          ...
          <div className="my-10 lg:my-52">
            ...
            <h1
              className="text-center py-20 text-4xl lg:text-5xl font-bold opacity-0 transition duration-700 title"
              id="anim_portofolio"
            >
              Portofolio
            </h1>
            ...
            <nav
              className="w-full mx-auto opacity-0 transition duration-700"
              id="nav_portofolio"
            >
              <ul className="flex w-full lg:w-8/12 justify-between lg:justify-center mx-auto p-3 text-center text-gray-100 text-sm lg:text-lg">
                <li
                  className={`w-1/4  cursor-pointer p-1 lg:p-2 ${this.state.portoNav === "All" ? "bg-blue-500" : " text-gray-800 border border-gray-500 "} hover:bg-blue-500 hover:text-white `}
                  onClick={() => this.updatePorto("All")}
                >
                  All
                </li>
                <li
                  className={`w-1/4 cursor-pointer p-1 lg:p-2 ${this.state.portoNav === "php" ? "bg-blue-500" : " text-gray-800 border border-gray-500 "} hover:bg-blue-500 hover:text-white`}
                  onClick={() => this.updatePorto("php")}
                >
                  Php
                </li>
                <li
                  className={`w-1/4 cursor-pointer p-1 lg:p-2 ${this.state.portoNav === "javascript" ? "bg-blue-500" : " text-gray-800 border border-gray-500 "} hover:bg-blue-500 hover:text-white`}
                  onClick={() => this.updatePorto("javascript")}
                >
                  Javascript
                </li>
                <li
                  className={`w-1/4 cursor-pointer p-1 lg:p-2 ${this.state.portoNav === "python" ? "bg-blue-500" : " text-gray-800 border border-gray-500 "} hover:bg-blue-500 hover:text-white`}
                  onClick={() => this.updatePorto("python")}
                >
                  Python
                </li>
              </ul>
            ...
            <div
              className="w-11/12 lg:w-8/12 mx-auto flex flex-wrap mt-10 transition duration-700 opacity-0"
              id="update_portofolio"
            >
              {allPortofolio.map((val, index) => (
                <ImgPortofolio
                  image={val.image_display}
                  name={val.name}
                  framework={val.framework}
                  type={val.lang}
                  index={index}
                  about={val.about_portofolio}
                  img_full={val.image_fullDisplay}
                  site={val.site}
                  button_type={val.button_type}
                  download={val.fileDownload}
                  github={val.github}
                />
              ))}
            </div>
          ...
          <div className="contact_content">
            <div className="contact py-20">
              <div id="contact"></div>
              <h1
                className="text-center pt-10 lg:pt-20 lg:pb-10 text-4xl lg:text-5xl font-bold opacity-0 transition duration-700 title_contact"
                id="anim_contact"
              >
                Contact
              </h1>
            ...
            <div
              className="text-white pb-32 opacity-0 transition duration-700"
              id="anim_msg_content"
            >
              <div className="w-11/12 lg:w-1/2 mx-auto divide-y divide-gray-800">
                <input
                  type="text"
                  className="w-full p-4 text-lg bg-gray-700 outline-none"
                ...
                /> */}
                <textarea
                  className="w-full h-60 p-4 text-lg bg-gray-700 outline-none"
                  placeholder="message"
                />
                <div className="flex w-full justify-end pt-2 mr-5 lg:mr-0">
                  <button className="bg-blue-500 px-5 py-2 lg:px-14 lg:py-3 text-white font-semibold rounded-lg">
                    Submit
                  </button>
                </div>
              </div>
              ...
              <ul className="flex justify-center" id="social_media">
                <a href="https://www.facebook.com/ahas.septianto/">
                  <li
                    ...
                    onMouseOver={() => this.contactHover("show", "facebook")}
                    onMouseOut={() => this.contactHover("hide", "facebook")}
                    id="facebook"
                  >
                    <img
                ...
                <a href="http://wa.me/+6285810217197">
                  <li
                    ...
                    onMouseOut={() => this.contactHover("hide", "whatsapp")}
                    id="whatsapp"
                  >
                    <img
                ...
                <a href="https://t.me/AhasEkoSeptianto">
                  <li
                    className="mx-3 lg:mx5 block h-16 w-16 overflow-hidden shadow hover:bg-blue-100"
                    onMouseOver={() => this.contactHover("show", "telegram")}
                    onMouseOut={() => this.contactHover("hide", "telegram")}
                    id="telegram"
                  >
                    <img
                      src="/image/icons/telegram.svg"
                      className="h-16 p-4"
                      id="contact_telegram"
                      alt="telegram"
                    />
                ...
                <a href="https://github.com/AhasEkoSeptianto">
                  <li
                    className="mx-3 lg:mx5 block h-16 w-16 overflow-hidden shadow hover:bg-blue-100"
                    onMouseOver={() => this.contactHover("show", "github")}
                    onMouseOut={() => this.contactHover("hide", "github")}
                    id="github"
                  >
                    <img
